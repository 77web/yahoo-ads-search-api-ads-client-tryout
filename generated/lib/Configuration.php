...
namespace YahooAdsSearchApi\Client;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://ads-search.yahooapis.jp/api/v0';
    ...
    {
        $report  = 'PHP SDK (YahooAdsSearchApi\Client) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "https://ads-search.yahooapis.jp/api/v0",
