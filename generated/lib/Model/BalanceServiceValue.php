 ...
 *
 * @category Class
 * @description &lt;ja&gt;BalanceValuesオブジェクトは、選択したアカウントの残高を表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;Explains its specified account balance.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class BalanceServiceValue implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'balance' => '\YahooAdsSearchApi\Client\Model\Balance',
     ...
     * Gets balance
     *
     * @return \YahooAdsSearchApi\Client\Model\Balance|null
     */
     ...
     * Sets balance
     *
     * @param \YahooAdsSearchApi\Client\Model\Balance|null $balance balance
     *
     * @return $this
     */
     ...
     * Sets errors
     *
     * @param \YahooAdsSearchApi\Client\Model\Error[]|null $errors <ja>エラーの内容です。</ja><br><en>Error detail.</en>
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $operation_succeeded <ja>処理結果です。</ja><br><en>The result of operation.</en>
     *
     * @return $this
     */
