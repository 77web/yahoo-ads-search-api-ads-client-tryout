 ...
 *
 * @category Class
 * @description &lt;ja&gt;RetargetingListServiceValueは、ターゲットリストのの実行結果（1 Entity）を保持するオブジェクトです。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;RetargetingListServiceValue is an object that holds results (one entity).&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RetargetingListServiceValue implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'target_list' => '\YahooAdsSearchApi\Client\Model\RetargetingListServiceTargetingList'
    ];
     ...
     * Gets target_list
     *
     * @return \YahooAdsSearchApi\Client\Model\RetargetingListServiceTargetingList|null
     */
     ...
     * Sets target_list
     *
     * @param \YahooAdsSearchApi\Client\Model\RetargetingListServiceTargetingList|null $target_list target_list
     *
     * @return $this
     */
