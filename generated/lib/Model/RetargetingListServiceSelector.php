 ...
 *
 * @category Class
 * @description &lt;ja&gt;RetargetingListServiceSelectorは、ターゲットリストの検索条件（実行パラメータ）を保持するオブジェクトです。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;RetargetingListServiceSelector is an object that holds search condition (parameter).&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RetargetingListServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'target_list_types' => '\YahooAdsSearchApi\Client\Model\RetargetingListServiceTargetListType[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['target_list_types'] = isset($data['target_list_types']) ? $data['target_list_types'] : null;
    }
     ...
     * Sets account_id
     *
     * @param int $account_id <ja>検索条件：アカウントIDです。</ja><br><en>Search conditon: Account ID.</en>
     *
     * @return $this
     */
     ...
     *
     * @param int[]|null $target_list_ids <ja>検索条件：ターゲットリストIDです。</ja><br><en>Search conditon: Target List ID.</en>
     *
     * @return $this
     */
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\RetargetingListServiceTargetListType[]|null $target_list_types target_list_types
     *
     * @return $this
     */
