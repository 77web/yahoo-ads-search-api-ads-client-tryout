 ...
 *
 * @category Class
 * @description &lt;ja&gt;AuditLogServiceSelectorオブジェクトは、登録したジョブを照会するための検索条件を保持します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;AuditLogServiceSelector object retains search criterias to inquire a created job.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AuditLogServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'job_ids' => 'int[]',
        'job_statuses' => '\YahooAdsSearchApi\Client\Model\AuditLogServiceJobStatus[]',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
     ...
     * Sets job_ids
     *
     * @param int[]|null $job_ids <ja>登録したジョブのIDです。</ja><br><en>Created job ID</en>
     *
     * @return $this
     */
     ...
     * Sets job_statuses
     *
     * @param \YahooAdsSearchApi\Client\Model\AuditLogServiceJobStatus[]|null $job_statuses job_statuses
     *
     * @return $this
     */
