 ...
 *
 * @category Class
 * @description &lt;ja&gt;AdGroupWebpageServiceSelectorオブジェクトは、取得する条件を保持します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;AdGroupWebpageServiceSelector object contains the rules to be acquired.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdGroupWebpageServiceSelector implements ModelInterface, ArrayAccess
{
     ...
     * Sets ad_group_ids
     *
     * @param int[]|null $ad_group_ids <ja>広告グループID</ja><br><en>AdGroup ID</en>
     *
     * @return $this
     */
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <ja>キャンペーンID</ja><br><en>Campaign ID</en>
     *
     * @return $this
     */
     ...
     * Sets target_ids
     *
     * @param int[]|null $target_ids <ja>配信/除外設定を識別するID</ja><br><en>Unique ID to identify &#39;Allow&#39; or &#39;Exclude&#39; settings</en>
     *
     * @return $this
     */
