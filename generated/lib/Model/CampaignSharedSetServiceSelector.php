 ...
 *
 * @category Class
 * @description &lt;ja&gt;CampaignSharedSetServiceSelectorは、検索条件（実行パラメータ）を保持するオブジェクトです。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;CampaignSharedSetServiceSelector is object to hold the search criteria (exec parameter).&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignSharedSetServiceSelector implements ModelInterface, ArrayAccess
{
     ...
     * Sets account_id
     *
     * @param int $account_id <ja>検索条件：アカウントIDです。</ja><br><en>Search criteria : Account ID.</en>
     *
     * @return $this
     */
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <ja>検索条件：キャンペーンIDです。</ja><br><en>Search criteria : Campaign ID.</en>
     *
     * @return $this
     */
     ...
     *
     * @param int[]|null $shared_list_ids <ja>検索条件：対象外キーワードリストIDです。</ja><br><en>Search criteria : Shared list ID.</en>
     *
     * @return $this
     */
