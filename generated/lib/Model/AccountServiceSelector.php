 ...
 *
 * @category Class
 * @description &lt;ja&gt;AccountServiceSelectorオブジェクトは、選択するアカウントを表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;Explains which accounts to return.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccountServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'account_ids' => 'int[]',
        'account_statuses' => '\YahooAdsSearchApi\Client\Model\AccountServiceStatus[]',
        'account_types' => '\YahooAdsSearchApi\Client\Model\AccountServiceType[]',
        'auth_type' => '\YahooAdsSearchApi\Client\Model\AccountServiceAuthType',
        'include_test_account' => '\YahooAdsSearchApi\Client\Model\AccountServiceIncludeTestAccount',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
     ...
     * Sets account_ids
     *
     * @param int[]|null $account_ids <ja>アカウントIDの配列です。</ja><br><en>Account IDs.</en>
     *
     * @return $this
     */
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\AccountServiceStatus[]|null $account_statuses account_statuses
     *
     * @return $this
     */
     ...
     * Sets account_types
     *
     * @param \YahooAdsSearchApi\Client\Model\AccountServiceType[]|null $account_types account_types
     *
     * @return $this
     */
     ...
     *
     * @return \YahooAdsSearchApi\Client\Model\AccountServiceIncludeTestAccount|null
     */
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\AccountServiceIncludeTestAccount|null $include_test_account include_test_account
     *
     * @return $this
     */
