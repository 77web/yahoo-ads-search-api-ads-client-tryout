 ...
 *
 * @category Class
 * @description &lt;ja&gt;AdGroupCriterionServiceSelectorオブジェクトは、操作の対象となる広告グループのクライテリアを表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;AdGroupCriterionServiceSelector object displays criteria of ad group to be operated.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdGroupCriterionServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'ad_group_ids' => 'int[]',
        'approval_statuses' => '\YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceApprovalStatus[]',
        'bidding_strategy_ids' => 'int[]',
        'campaign_ids' => 'int[]',
        'contains_label_id' => '\YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceContainsLabelId',
        'criterion_ids' => 'int[]',
        'label_ids' => 'int[]',
        'number_results' => 'int',
        'start_index' => 'int',
        'use' => '\YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceUse',
        'user_statuses' => '\YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceUserStatus[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['contains_label_id'] = isset($data['contains_label_id']) ? $data['contains_label_id'] : null;
     ...
     * Sets account_id
     *
     * @param int $account_id <ja>検索条件：アカウントID</ja><br><en>Search condition: Account ID.</en>
     *
     * @return $this
     */
     ...
     * Sets ad_group_ids
     *
     * @param int[]|null $ad_group_ids <ja>検索条件：広告グループID</ja><br><en>Search condition: Ad group ID.</en>
     *
     * @return $this
     */
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceApprovalStatus[]|null $approval_statuses approval_statuses
     *
     * @return $this
     */
     ...
     *
     * @param int[]|null $bidding_strategy_ids <ja>検索条件：自動入札ID</ja><br><en>Search condition: Auto bidding ID.</en>
     *
     * @return $this
     */
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <ja>検索条件：キャンペーンID</ja><br><en>Search condition: Campaign ID.</en>
     *
     * @return $this
     */
     ...
     *
     * @return \YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceContainsLabelId|null
     */
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceContainsLabelId|null $contains_label_id contains_label_id
     *
     * @return $this
     */
     ...
     * Sets criterion_ids
     *
     * @param int[]|null $criterion_ids <ja>検索条件：クライテリオンID<br>指定しない場合は、広告グループID以下のすべてのクライ テリアが含まれます。</ja><br><en>Search condition: Criterion ID.<br>* All criteria under the Ad group ID will return if theres is no designation.</en>
     *
     * @return $this
     */
     ...
     * Sets label_ids
     *
     * @param int[]|null $label_ids <ja>検索条件：ラベルID</ja><br><en>Search condition: Label ID</en>
     *
     * @return $this
     */
     ...
     * Gets use
     *
     * @return \YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceUse
     */
     ...
     * Sets use
     *
     * @param \YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceUse $use use
     *
     * @return $this
     */
     ...
     * Sets user_statuses
     *
     * @param \YahooAdsSearchApi\Client\Model\AdGroupCriterionServiceUserStatus[]|null $user_statuses user_statuses
     *
     * @return $this
     */
