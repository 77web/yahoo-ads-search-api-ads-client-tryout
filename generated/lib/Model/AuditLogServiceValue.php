 ...
 *
 * @category Class
 * @description &lt;ja&gt;AuditLogServiceValueオブジェクトは、実行結果（1エンティティ）を保持します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;AuditLogServiceValue object retains the operation result (1 entity).&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AuditLogServiceValue implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'job' => '\YahooAdsSearchApi\Client\Model\AuditLogServiceJob',
     ...
     * Gets job
     *
     * @return \YahooAdsSearchApi\Client\Model\AuditLogServiceJob|null
     */
     ...
     * Sets job
     *
     * @param \YahooAdsSearchApi\Client\Model\AuditLogServiceJob|null $job job
     *
     * @return $this
     */
