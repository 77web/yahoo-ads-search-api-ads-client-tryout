 ...
 *
 * @category Class
 * @description &lt;ja&gt;AdGroupServiceValueオブジェクトは、処理結果を含む広告グループに関する情報を表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;AdGroupServiceValue object displays ad group information including its operation results.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdGroupServiceValue implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'ad_group' => '\YahooAdsSearchApi\Client\Model\AdGroup',
     ...
     * Gets ad_group
     *
     * @return \YahooAdsSearchApi\Client\Model\AdGroup|null
     */
     ...
     * Sets ad_group
     *
     * @param \YahooAdsSearchApi\Client\Model\AdGroup|null $ad_group ad_group
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $operation_succeeded <ja>処理結果を表示します。</ja><br><en>Result of process.</en>
     *
     * @return $this
     */
