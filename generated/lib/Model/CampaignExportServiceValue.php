 ...
 *
 * @category Class
 * @description &lt;ja&gt;CampaignExportServiceValueオブジェクトは、実行結果（1 Entity）を含むジョブ情報を表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;CampaignExportServiceValue object describes the job information per entity in operation result.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignExportServiceValue implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'job' => '\YahooAdsSearchApi\Client\Model\CampaignExportServiceJob',
     ...
     * Gets job
     *
     * @return \YahooAdsSearchApi\Client\Model\CampaignExportServiceJob|null
     */
     ...
     * Sets job
     *
     * @param \YahooAdsSearchApi\Client\Model\CampaignExportServiceJob|null $job job
     *
     * @return $this
     */
