 ...
 *
 * @category Class
 * @description &lt;ja&gt;RetargetingListServiceOperationは、操作対象のターゲットリストを保持するオブジェクトです。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;RetargetingListServiceOperation is an object that holds target retargeting.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RetargetingListServiceOperation implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'operand' => '\YahooAdsSearchApi\Client\Model\RetargetingListServiceTargetingList[]',
     ...
     * Gets operand
     *
     * @return \YahooAdsSearchApi\Client\Model\RetargetingListServiceTargetingList[]
     */
     ...
     * Sets operand
     *
     * @param \YahooAdsSearchApi\Client\Model\RetargetingListServiceTargetingList[] $operand operand
     *
     * @return $this
     */
