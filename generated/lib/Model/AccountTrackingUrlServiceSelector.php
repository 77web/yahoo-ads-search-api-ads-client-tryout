 ...
 *
 * @category Class
 * @description &lt;ja&gt;AccountTrackingUrlServiceSelectorオブジェクトは、アカウントトラッキング情報のget処理の検索条件を表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;AccountTrackingUrlServiceSelector object describes the account tracking details.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccountTrackingUrlServiceSelector implements ModelInterface, ArrayAccess
{
     ...
     * Sets account_ids
     *
     * @param int[]|null $account_ids <ja>検索条件：アカウントIDです。</ja><br><en>Search condition: Account ID.</en>
     *
     * @return $this
     */
