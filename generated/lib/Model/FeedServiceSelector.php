 ...
 *
 * @category Class
 * @description &lt;ja&gt;FeedServiceSelectorオブジェクトは、自動データ挿入のリストの基本情報を格納します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;FeedServiceSelector describes the basic information of list of Data auto insertion.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class FeedServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'feed_ids' => 'int[]',
        'number_results' => 'int',
        'placeholder_types' => '\YahooAdsSearchApi\Client\Model\FeedServicePlaceholderType[]',
        'start_index' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['number_results'] = isset($data['number_results']) ? $data['number_results'] : 50;
     ...
     * Sets feed_ids
     *
     * @param int[]|null $feed_ids <ja>自動データ挿入のリストのIDです。</ja><br><en>List ID of Feed.</en>
     *
     * @return $this
     */
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\FeedServicePlaceholderType[]|null $placeholder_types placeholder_types
     *
     * @return $this
     */
