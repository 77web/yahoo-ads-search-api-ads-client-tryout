 ...
 *
 * @category Class
 * @description &lt;ja&gt;CampaignExportServiceSelector オブジェクトは、登録したジョブを検索する条件を表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;CampaignExportServiceSelector object describes the condition to search registered job settings.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignExportServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'job_ids' => 'int[]',
        'job_statuses' => '\YahooAdsSearchApi\Client\Model\CampaignExportServiceJobStatus[]',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['job_statuses'] = isset($data['job_statuses']) ? $data['job_statuses'] : null;
     ...
     * Sets job_ids
     *
     * @param int[]|null $job_ids <ja>検索条件：ジョブIDです。</ja><br><en>Search condition: Job ID.</en>
     *
     * @return $this
     */
     ...
     * Sets job_statuses
     *
     * @param \YahooAdsSearchApi\Client\Model\CampaignExportServiceJobStatus[]|null $job_statuses job_statuses
     *
     * @return $this
     */
