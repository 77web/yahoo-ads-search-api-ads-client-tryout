 ...
 *
 * @category Class
 * @description &lt;ja&gt;CampaignServiceSelectorオブジェクトは、操作の対象とするキャンペーンの情報およびフィルタ条件を表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;CampaignServiceSelector object displays information and filter criteria of campaign to be operated.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'campaign_ids' => 'int[]',
        'contains_label_id' => '\YahooAdsSearchApi\Client\Model\CampaignServiceContainsLabelId',
        'label_ids' => 'int[]',
        'number_results' => 'int',
        'start_index' => 'int',
        'user_statuses' => '\YahooAdsSearchApi\Client\Model\CampaignServiceUserStatus[]'
    ];
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <ja>検索条件：キャンペーンID<br>※指定しない場合は、フィルタ条件に すべてのキャンペーンが含まれます。</ja><br><en>Search condition: Campaign ID<br>* All campaign will return, if no campaign are not specified.</en>
     *
     * @return $this
     */
     ...
     *
     * @return \YahooAdsSearchApi\Client\Model\CampaignServiceContainsLabelId|null
     */
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\CampaignServiceContainsLabelId|null $contains_label_id contains_label_id
     *
     * @return $this
     */
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 2000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling CampaignServiceSelector., must be smaller than or equal to 2000.');
        }
     ...
     * Sets user_statuses
     *
     * @param \YahooAdsSearchApi\Client\Model\CampaignServiceUserStatus[]|null $user_statuses user_statuses
     *
     * @return $this
     */
