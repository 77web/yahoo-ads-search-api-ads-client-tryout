 ...
 *
 * @category Class
 * @description &lt;ja&gt;AdGroupAdServiceSelectorオブジェクトは、操作の対象とする広告およびフィルタ条件を表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;AdGroupAdServiceSelector object describes the information and filter criteria of the Ads to be operated on.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdGroupAdServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'ad_group_ids' => 'int[]',
        'ad_ids' => 'int[]',
        'ad_types' => '\YahooAdsSearchApi\Client\Model\AdGroupAdServiceAdType[]',
        'approval_statuses' => '\YahooAdsSearchApi\Client\Model\AdGroupAdServiceApprovalStatus[]',
        'campaign_ids' => 'int[]',
        'contains_label_id' => '\YahooAdsSearchApi\Client\Model\AdGroupAdServiceContainsLabelId',
        'label_ids' => 'int[]',
        'number_results' => 'int',
        'start_index' => 'int',
        'user_statuses' => '\YahooAdsSearchApi\Client\Model\AdGroupAdServiceUserStatus[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ad_types'] = isset($data['ad_types']) ? $data['ad_types'] : null;
     ...
     * Sets ad_group_ids
     *
     * @param int[]|null $ad_group_ids <ja>検索条件：広告グループID</ja><br><en>Search condition: Ad group ID.<br>Ads returned will be from adgroups whose ids are included in this list.</en>
     *
     * @return $this
     */
     ...
     * Sets ad_ids
     *
     * @param int[]|null $ad_ids <ja>検索条件：広告ID</ja><br><en>Search condition: Ad ID.<br>Ads will return from ads whose ids are included in this list.<br>If you omit adIds field, it will return all adIds under the adGroup.</en>
     *
     * @return $this
     */
     ...
     * Sets ad_types
     *
     * @param \YahooAdsSearchApi\Client\Model\AdGroupAdServiceAdType[]|null $ad_types ad_types
     *
     * @return $this
     */
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\AdGroupAdServiceApprovalStatus[]|null $approval_statuses approval_statuses
     *
     * @return $this
     */
     ...
     *
     * @return \YahooAdsSearchApi\Client\Model\AdGroupAdServiceContainsLabelId|null
     */
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\AdGroupAdServiceContainsLabelId|null $contains_label_id contains_label_id
     *
     * @return $this
     */
     ...
     * Sets user_statuses
     *
     * @param \YahooAdsSearchApi\Client\Model\AdGroupAdServiceUserStatus[]|null $user_statuses user_statuses
     *
     * @return $this
     */
