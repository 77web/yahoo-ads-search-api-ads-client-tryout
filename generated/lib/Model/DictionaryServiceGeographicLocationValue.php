 ...
 *
 * @category Class
 * @description &lt;ja&gt;DictionaryServiceGeographicLocationValueオブジェクトは、地域情報と処理の内容を表します。&lt;/ja&gt;&lt;br&gt;&lt;en&gt;DictionaryServiceGeographicLocationValue object describes Geographic location and operation information.&lt;/en&gt;
 * @package  YahooAdsSearchApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DictionaryServiceGeographicLocationValue implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'geographic_location' => '\YahooAdsSearchApi\Client\Model\DictionaryServiceGeographicLocation',
     ...
     *
     * @param \YahooAdsSearchApi\Client\Model\DictionaryServiceGeographicLocation|null $geographic_location geographic_location
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $operation_succeeded <ja>オペレーション成功です。</ja><br><en>Operation is successful.</en>
     *
     * @return $this
     */
