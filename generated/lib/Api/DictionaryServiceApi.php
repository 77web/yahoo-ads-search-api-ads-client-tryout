...
class DictionaryServiceApi
{
     ...
     *
     * @param  \YahooAdsSearchApi\Client\Model\DictionaryServiceDisapprovalReasonSelector $dictionary_service_disapproval_reason_selector dictionary_service_disapproval_reason_selector (optional)
     *
     * @throws \YahooAdsSearchApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return |\YahooAdsSearchApi\Client\Model\DictionaryServiceGetDisapprovalReasonResponse
     */
     ...
     *
     * @param  \YahooAdsSearchApi\Client\Model\DictionaryServiceDisapprovalReasonSelector $dictionary_service_disapproval_reason_selector (optional)
     *
     * @throws \YahooAdsSearchApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of |\YahooAdsSearchApi\Client\Model\DictionaryServiceGetDisapprovalReasonResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function dictionaryServiceGetDisapprovalReasonPostWithHttpInfo($dictionary_service_disapproval_reason_selector = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\YahooAdsSearchApi\Client\Model\DictionaryServiceGetDisapprovalReasonResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\YahooAdsSearchApi\Client\Model\DictionaryServiceGetDisapprovalReasonResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\YahooAdsSearchApi\Client\Model\DictionaryServiceGetDisapprovalReasonResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\YahooAdsSearchApi\Client\Model\DictionaryServiceGetDisapprovalReasonResponse',
     ...
     *
     * @param  \YahooAdsSearchApi\Client\Model\DictionaryServiceGeographicLocationSelector $dictionary_service_geographic_location_selector dictionary_service_geographic_location_selector (optional)
     *
     * @throws \YahooAdsSearchApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return |\YahooAdsSearchApi\Client\Model\DictionaryServiceGetGeographicLocationResponse
     */
     ...
     *
     * @param  \YahooAdsSearchApi\Client\Model\DictionaryServiceGeographicLocationSelector $dictionary_service_geographic_location_selector (optional)
     *
     * @throws \YahooAdsSearchApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of |\YahooAdsSearchApi\Client\Model\DictionaryServiceGetGeographicLocationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function dictionaryServiceGetGeographicLocationPostWithHttpInfo($dictionary_service_geographic_location_selector = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\YahooAdsSearchApi\Client\Model\DictionaryServiceGetGeographicLocationResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\YahooAdsSearchApi\Client\Model\DictionaryServiceGetGeographicLocationResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\YahooAdsSearchApi\Client\Model\DictionaryServiceGetGeographicLocationResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\YahooAdsSearchApi\Client\Model\DictionaryServiceGetGeographicLocationResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
